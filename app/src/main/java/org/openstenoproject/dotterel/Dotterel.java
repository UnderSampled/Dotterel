...
import org.openstenoproject.dotterel.Input.NKeyRolloverMachine;
import org.openstenoproject.dotterel.Input.StenoMachine;
import org.openstenoproject.dotterel.Input.TXBoltMachine;
import org.openstenoproject.dotterel.Input.TouchLayer;
...
import org.openstenoproject.dotterel.Translator.SimpleTranslator;
import org.openstenoproject.dotterel.Translator.Stroke;
import org.openstenoproject.dotterel.Translator.TranslationResult;
import org.openstenoproject.dotterel.Translator.Translator;
import org.openstenoproject.dotterel.data.DBContract.StatsEntry;
import org.openstenoproject.dotterel.data.StatsTableHelper;
import org.openstenoproject.dotterel.performance.PerformanceItem;
 ...
 */
public class Dotterel extends InputMethodService implements TouchLayer.OnStrokeListener,
        StenoMachine.OnStrokeListener, Dictionary.OnDictionaryLoadedListener, TextToSpeech.OnInitListener {

    private static final String STENO_STROKE = "org.openstenoproject.STENO_STROKE";
    private static final String TAG = Dotterel.class.getSimpleName();
    private static final String ACTION_USB_PERMISSION = "org.openstenoproject.USB_PERMISSION";
    ...
    private DotterelApp App; // to make it easier to access the Application class
    ...
    public void onCreate() {
        ...
        PreferenceManager.setDefaultValues(this, org.openstenoproject.dotterel.R.xml.preferences, false); //load default values
        resetStats();
    ...
    public View onCreateInputView() {
        ...
        mKeyboard = (LinearLayout) inflater.inflate(org.openstenoproject.dotterel.R.layout.keyboard, null);
        TouchLayer touchLayer = (TouchLayer) mKeyboard.findViewById(org.openstenoproject.dotterel.R.id.keyboard);
        touchLayer.setOnStrokeListener(this);
        mKeyboard.findViewById(org.openstenoproject.dotterel.R.id.settings_button).setOnClickListener(new View.OnClickListener() {
            @Override
...
//TXBOLT:        unregisterReceiver(mUsbReceiver);
    ...
    private void showSpecialKeysDialog() {
        ...
        LayoutInflater inflater = getLayoutInflater();
        View dialog_view = inflater.inflate(org.openstenoproject.dotterel.R.layout.specialkeys, null);
        lockKeyboard();
        ...
        Button submit_button = (Button) dialog_view.findViewById(org.openstenoproject.dotterel.R.id.submit_button);
        submit_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dotterel.this.sendDownUpKeyEvents(KeyEvent.KEYCODE_ENTER);
            }
        });
        Button settings_button = (Button) dialog_view.findViewById(org.openstenoproject.dotterel.R.id.settings_button);
        ...
        Button reset_button = (Button) dialog_view.findViewById(org.openstenoproject.dotterel.R.id.reset_button);
        ...
        Button switch_input_button = (Button) dialog_view.findViewById(org.openstenoproject.dotterel.R.id.switch_input_button);
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_exclamation).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_at).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_hash).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_dollars).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_percent).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_carat).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_ampersand).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_asterisk).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_openbracket).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_closebracket).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_singlequote).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_doublequote).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_slash).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        dialog_view.findViewById(org.openstenoproject.dotterel.R.id.key_question).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alert.dismiss();
                unlockKeyboard();
        ...
        Button close_button = (Button) dialog_view.findViewById(org.openstenoproject.dotterel.R.id.close_button);
    ...
    private void initializeCandidatesView() {
        candidates_view = getLayoutInflater().inflate(org.openstenoproject.dotterel.R.layout.preview, null);
        ...
        preview = (TextView) candidates_view.findViewById(org.openstenoproject.dotterel.R.id.preview);
        preview_overlay = (LinearLayout) candidates_view.findViewById(org.openstenoproject.dotterel.R.id.preview_overlay);
        debug_text = (TextView) candidates_view.findViewById(org.openstenoproject.dotterel.R.id.debug);
        // register the progress bar with the application, for dictionary loading
        App.setProgressBar((ProgressBar) preview_overlay.findViewById(org.openstenoproject.dotterel.R.id.progressBar));
        if (App.isNKRO_enabled()) onCreateCandidatesView();  //make sure to run this
    }

    private void initializePreview() {
        Log.d(TAG, "initializePreview()");
        inline_preview = prefs.getBoolean(getString(org.openstenoproject.dotterel.R.string.key_inline_preview), true);
        if (App.isDictionaryLoaded()) {
    ...
    private void initializeTranslator() {
        ...
        switch (App.getTranslatorType()) {
            ...
            case SimpleDictionary:
                ...
                ((SimpleTranslator) mTranslator).setDictionary(App.getDictionary(Dotterel.this));
                break;
        }
        mTranslator.start();
    }
...
//            }
        ...
        if (App.showPerformanceNotifications()) {
            if (stats.strokes()>10 && stats.letters()>10) {
                ...
                if (time - last_notification_time > 2000) {
                    Intent suggestionIntent = new Intent(getApplicationContext(), Dotterel.class);
                    ...
                    NotificationCompat.Builder mBuilder =
                            new NotificationCompat.Builder(this)
                                    .setSmallIcon(org.openstenoproject.dotterel.R.drawable.ic_stat_dotterel)
    ...
    private void lockKeyboard() {
        ...
        if ((mKeyboard != null) && (App.getMachineType() == StenoMachine.TYPE.VIRTUAL)) {
            View overlay = mKeyboard.findViewById(org.openstenoproject.dotterel.R.id.overlay);
    ...
    private void showPreviewBar(boolean show) {
        ...
        View shadow = mKeyboard.findViewById(org.openstenoproject.dotterel.R.id.shadow);
        if (shadow!=null) {
    ...
    private void setMachineType(StenoMachine.TYPE t) {
        ...
        saveIntPreference(getString(org.openstenoproject.dotterel.R.string.key_machine_type), App.getMachineType().ordinal());
