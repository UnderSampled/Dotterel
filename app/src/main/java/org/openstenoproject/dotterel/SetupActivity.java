...
public class SetupActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.openstenoproject.dotterel.R.layout.activity_setup);
        btn_enable = (Button)findViewById(org.openstenoproject.dotterel.R.id.btn_enable);
        btn_select = (Button)findViewById(org.openstenoproject.dotterel.R.id.btn_select);
        btn_learn = (Button)findViewById(org.openstenoproject.dotterel.R.id.btn_learn);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(org.openstenoproject.dotterel.R.menu.setup, menu);
        return true;
    }
