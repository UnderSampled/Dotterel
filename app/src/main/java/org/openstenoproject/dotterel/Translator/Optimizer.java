package org.openstenoproject.dotterel.Translator;
...
import org.openstenoproject.dotterel.R;
import org.openstenoproject.dotterel.DotterelApp;
import org.openstenoproject.dotterel.SuggestionsActivity;
import org.openstenoproject.dotterel.data.DBContract.DictionaryEntry;
import org.openstenoproject.dotterel.data.DBContract.OptimizationEntry;
import org.openstenoproject.dotterel.data.LookupTableHelper;
...
public class Optimizer {
    ...
    public void initialize() {
        assert(((DotterelApp)mContext).isDictionaryLoaded());
        new BackgroundLoader().execute(((DotterelApp) mContext).getDictionary(null));
    }
    ...
    private void sendNotification(Candidate optimization) {
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(mContext)
                        .setSmallIcon(R.drawable.ic_stat_dotterel)
